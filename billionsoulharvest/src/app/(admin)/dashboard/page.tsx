      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border">
          <div className="px-5 py-4 border-b flex items-center justify-between">
            ...
            <Link href="/registrations" className="text-sm text-emerald-600 hover:text-emerald-700">View all</Link>
          </div>
        ...
        <div className="bg-white rounded-xl border">
          <div className="px-5 py-4 border-b flex items-center justify-between">
            ...
            <Link href="/follow-ups" className="text-sm text-emerald-600 hover:text-emerald-700">View all</Link>
          </div>
          <div className="divide-y">
