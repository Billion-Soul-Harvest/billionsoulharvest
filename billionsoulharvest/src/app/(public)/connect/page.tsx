    ...
    <div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Partner With Us */}
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8 hover:border-[#29BDD6]/30 hover:shadow-lg transition-all group">
      ...
      <section className="bg-white py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold text-[#0f2744] mb-4">
            Contact Us
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a
              ...
              className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#0f2744] hover:border-[#29BDD6]/30 hover:shadow-lg transition-all"
            >
            ...
            <Link
              href="/events"
              className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-gray-600 hover:border-[#29BDD6]/30 hover:text-[#0f2744] hover:shadow-lg transition-all"
            >
              <svg className="w-5 h-5 text-[#29BDD6] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
