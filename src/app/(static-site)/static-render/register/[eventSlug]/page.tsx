...
export default async function RegisterPage({ params }: Props) {
  ...
  const showBanner = regConfig?.showBanner === true;
  const showHeroContent = regConfig?.showHeroContent !== false;
  ...
  return (
    <div className="min-h-screen bg-[#f9f9ff] relative overflow-hidden">
      ...
      <header className="relative">
        ...
        <div className={`relative max-w-4xl mx-auto px-6 text-center ${showHeroContent ? 'pt-12 pb-16 sm:pt-20 sm:pb-24' : ''}`}>
          {showHeroContent && (
            <>
              {/* Ministry badge */}
      ...
      <main id="register-form" className="relative max-w-2xl mx-auto px-6 -mt-4 pb-20">
