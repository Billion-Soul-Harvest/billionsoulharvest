    ...
    <footer className="bg-[#0d223f] py-8">
      <div className="max-w-[1280px] mx-auto px-4 md:px-[80px] grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="md:col-span-1">
          ...
          <p className="font-[family-name:var(--font-jakarta)] text-base leading-relaxed text-white/70">
        ...
        <div>
          <h6 className="font-[family-name:var(--font-geist-sans)] text-sm font-semibold text-white mb-6 uppercase tracking-widest">
            Explore
          </h6>
          <ul className="space-y-4 font-[family-name:var(--font-geist-sans)] text-base text-white/60">
            <li>
              <Link href="/about" className="hover:text-[#00b8d4] transition-colors">
                About Us
              </Link>
            </li>
            <li>
      ...
      <div className="max-w-[1280px] mx-auto px-8 mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="font-[family-name:var(--font-geist-sans)] text-sm text-white/40">
