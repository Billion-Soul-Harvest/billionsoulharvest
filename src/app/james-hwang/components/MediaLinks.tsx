...
import { Images, Globe, ArrowUpRight, ExternalLink } from "lucide-react";
import { mediaLinks } from "../data";

export default function MediaLinks() {
  return (
    <section id="media" className="py-24 bg-[#f9f9ff] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {mediaLinks.map((media, idx) => {
            const isMedia = media.platform === "MEDIA";
            return (
              <a
                key={idx}
                href={media.url}
              ...
              >
                ...
                <div className="flex items-center space-x-2 text-xs font-[family-name:var(--font-geist-sans)] font-bold text-[#006879] group-hover:text-[#00b8d4] transition-colors mt-auto">
                  ...
                  <span>
                    Visit {isMedia ? "Media Gallery" : "Official Portal"}
                  </span>
                </div>
              </a>
            );
