          ...
          {events && events.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {events.map((event) => {
                ...
                const isClickable = hasExternalUrl || !!event.page_content;
                ...
                const cardContent = (
                  <>
                    ...
                    <div className="p-5">
                      ...
                      <h3 className={`font-[family-name:var(--font-heading)] text-lg font-bold text-white ${isClickable ? "group-hover:text-[#29BDD6]" : ""} transition-colors mb-2`}>
                        {event.title}
                      </h3>
