...
export default async function TeamPage({ params }: Props) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {team.description && <p className="text-gray-500 mt-2">{team.description}</p>}

      <div className="mt-6 bg-white rounded-xl border p-6">
        <div className="flex gap-8 mb-4">
          <div>
            <p className="text-2xl font-bold text-gray-900">{formatCents(totalRaised)}</p>
      ...
      {/* Members */}
      <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Team Members</h2>
      ...
      {/* Team campaigns */}
      <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Team Campaigns</h2>
