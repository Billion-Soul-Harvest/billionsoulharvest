...
export const componentSchemas: ComponentSchema[] = [
  ...
  {
    resolvedName: "CraftDialog",
    isCanvas: false,
    description: "Button that opens a modal dialog overlay showing a YouTube video, image, or MP4 video. Configure content via props.",
    props: [
      { name: "buttonText", type: "string", default: "Watch Video" },
      { name: "bgColor", type: "string (hex/rgba)", default: "#29BDD6" },
      { name: "textColor", type: "string (hex/rgba)", default: "#ffffff" },
      { name: "fontSize", type: "number", default: 16 },
      { name: "paddingX", type: "number", default: 32 },
      { name: "paddingY", type: "number", default: 16 },
      { name: "borderRadius", type: "number", default: 12 },
      { name: "buttonWidth", type: "number", default: 220 },
      { name: "dialogWidth", type: "number", default: 700 },
      { name: "dialogBgColor", type: "string (hex/rgba)", default: "#0f2744" },
      { name: "contentType", type: '"youtube" | "image" | "video"', default: "youtube" },
      { name: "contentUrl", type: "string (URL)", default: "" },
    ],
  },
  {
