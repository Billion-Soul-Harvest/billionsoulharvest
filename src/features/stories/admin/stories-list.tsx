        ...
        {stories.map((story) => (
          ...
          >
            ...
            <Link href={`/admin/stories/edit/${story.id}`} className="block">
              <div className="relative w-full aspect-[16/9] bg-gradient-to-br from-[#29BDD6]/20 to-[#29BDD6]/40 overflow-hidden flex items-center justify-center">
                <svg className="w-10 h-10 text-[#29BDD6]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
