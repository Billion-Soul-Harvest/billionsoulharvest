...
### UI Testing
- Always use the `playwright-ui-testing` skill when testing UI changes in the browser.
- Credentials and base URL are in `.env.local` as `E2E_EMAIL`, `E2E_PASSWORD`, `E2E_BASE_URL`.
